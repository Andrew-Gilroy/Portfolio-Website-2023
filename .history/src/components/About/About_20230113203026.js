        ...
        <div className="about_grid_wrapper">
            ...
            <div className="about_text_wrapper">
                ...
                <div className="svg_icons_wrapper">
                    <StaticImage src={photoshop_cc} title="Adobe Photoshop" alt="Adobe Photoshop" className="svg_icon"></img>
                    <StaticImage src={illustrator_cc} alt="Adobe Illustrator" title="Adobe Illustrator" className="svg_icon"></img>
                    <StaticImage src={indesign_cc} alt="Adobe Indesign" title="Adobe Indesign" className="svg_icon"></img>
                    <StaticImage src={adobeXd_cc} alt="Adobe Xd" title="Adobe Xd" className="svg_icon"></img>
                    <StaticImage src={lightroom_cc} alt="Adobe Lightroom" title="Adobe Lightroom" className="svg_icon"></img>
                    <StaticImage src={after_effects_cc} alt="Adobe AfterEffects" title="Adobe After Effects" className="svg_icon"></img>
                    <StaticImage src={premiere_cc} alt="Adobe PremierPro" title="Adobe Premier Pro" className="svg_icon"></img>
                    <StaticImage src={blender} alt="Blender" title="Blender" className="svg_icon"></img>
                </div>
