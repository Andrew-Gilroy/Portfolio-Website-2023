...
const About = () => { 
    ...
    <a href="/" id="about" className="hidden_A_link" aria-hidden="true"></a>
        <div className="about_grid_wrapper">
            ...
            <StaticImage src={profile_image_cropped} alt="Andrew's Profile Image" className="about_profile_image--mobile" placeholder="blurred"/>
            ...
            <div className="about_text_wrapper">
                ...
                <div className="svg_icons_wrapper">
                    <StaticImage src={photoshop_cc} alt="Adobe Photoshop" title="Adobe Photoshop" className="svg_icon"/>
                    <StaticImage src={illustrator_cc} alt="Adobe Illustrator" title="Adobe Illustrator" className="svg_icon"/>
                    <StaticImage src={indesign_cc} alt="Adobe Indesign" title="Adobe Indesign" className="svg_icon"/>
                    <StaticImage src={adobeXd_cc} alt="Adobe Xd" title="Adobe Xd" className="svg_icon"></img>
                    <StaticImage src={lightroom_cc} alt="Adobe Lightroom" title="Adobe Lightroom" className="svg_icon"/>
                    <StaticImage src={after_effects_cc} alt="Adobe AfterEffects" title="Adobe After Effects" className="svg_icon"/>
                    <StaticImage src={premiere_cc} alt="Adobe PremierPro" title="Adobe Premier Pro" className="svg_icon"/>
                    <StaticImage src={blender} alt="Blender" title="Blender" className="svg_icon"/>
                </div>
                <div className="svg_icons_wrapper-webdev">
                    <StaticImage src={html} alt="Html" title="Html" className="svg_icon"></img>
                    <StaticImage src={css} alt="CSS" title="CSS" className="svg_icon"></img>
                    <StaticImage src={javascript} alt="Javascript" title="Javascript" className="svg_icon"></img>
                    <StaticImage src={npm} alt="NPM" title="NPM" className="svg_icon"></img>
                    <StaticImage src={react} alt="React" title="React" className="svg_icon"></img>
                    <StaticImage src={gatsby} alt="Gatsby" title="Gatsby" className="svg_icon"></img>
                </div>
            </div>
