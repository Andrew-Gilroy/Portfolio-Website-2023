...
const About = () => { 
    ...
    <a href="/" id="about" className="hidden_A_link" aria-hidden="true"></a>
        <div className="about_grid_wrapper">
            ...
            <StaticImage src="../../images/profile_picture/profile_image_cropped.png" alt="Andrew's Profile Image" className="about_profile_image--mobile" placeholder="blurred"/>
            ...
            <div className="about_text_wrapper">
                ...
                <div className="svg_icons_wrapper">
                    ...
                    <StaticImage src={adobeXd_cc} alt="Adobe Xd" title="Adobe Xd" className="svg_icon"/>
