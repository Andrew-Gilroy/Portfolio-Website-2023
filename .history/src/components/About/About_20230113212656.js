        ...
        <div className="about_grid_wrapper">
            ...
            <div className="about_text_wrapper">
                ...
                <div className="svg_icons_wrapper">
                    ...
                    <StaticImage src="../../images/svgicons/photoshop-cc.svg" alt="Adobe PremierPro" title="Adobe Premier Pro" className="svg_icon"/>
                    <StaticImage src="../../images/svgicons/photoshop-cc.svg" alt="Blender" title="Blender" className="svg_icon"/>
                </div>
                <div className="svg_icons_wrapper-webdev">
                    <StaticImage src={html} alt="Html" title="Html" className="svg_icon"/>
