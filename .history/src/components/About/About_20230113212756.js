        ...
        <div className="about_grid_wrapper">
            ...
            <div className="about_text_wrapper">
                ...
                <div className="svg_icons_wrapper-webdev">
                    ...
                    <StaticImage src="../../images/svgicons/blendericon.svg" alt="CSS" title="CSS" className="svg_icon"/>
                    <StaticImage src={javascript} alt="Javascript" title="Javascript" className="svg_icon"/>
