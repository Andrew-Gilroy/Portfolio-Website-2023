        ...
        <div className="about_grid_wrapper">
            ...
            <div className="about_text_wrapper">
                ...
                <div className="svg_icons_wrapper-webdev">
                    ...
                    <StaticImage src="../../images/svgicons/css.svg" alt="NPM" title="NPM" className="svg_icon"/>
                    <StaticImage src="../../images/svgicons/css.svg" alt="React" title="React" className="svg_icon"/>
