    ...
    <a href="/" id="about" className="hidden_A_link" aria-hidden="true"></a>
        <div className="about_grid_wrapper">
            ...
            <div className="about_text_wrapper">
                ...
                <hr id="aboutHR"></hr>
                <p className="about_text">I am a creative design professional now based in Glasgow. I have 5 years design experience across a broad spectrum of competencies:</p>
