...
import { fa-buysellads } from '@fortawesome/free-brands-svg-icons';
        ...
        <div className="about_grid_wrapper">
            ...
            <div className="about_text_wrapper">
                ...
                <FontAwesomeIcon icon="fa-brands fa-buysellads" />
                    ...
                    <li><FontAwesomeIcon icon={fa-buysellads} className="about_paragraph_list_icon"/><h3 className="about_paragraph_list_text">Adobe Creative Cloud</h3></li>
                ...
                <div className="svg_icons_wrapper">
                    <StaticImage src="../../images/svgicons/photoshop-cc.svg" alt="Adobe Photoshop" title="Adobe Photoshop" className="svg_icon"/>
                    <StaticImage src="../../images/svgicons/adobe-illustrator-cc.svg" alt="Adobe Illustrator" title="Adobe Illustrator" className="svg_icon"/>
                    <StaticImage src="../../images/svgicons/indesign-cc.svg" alt="Adobe Indesign" title="Adobe Indesign" className="svg_icon"/>
                    <StaticImage src="../../images/svgicons/adobe-xd.svg" alt="Adobe Xd" title="Adobe Xd" className="svg_icon"/>
                    <StaticImage src="../../images/svgicons/lightroom_classic_cc.svg" alt="Adobe Lightroom" title="Adobe Lightroom" className="svg_icon"/>
                    <StaticImage src="../../images/svgicons/after-effects-cc.svg" alt="Adobe AfterEffects" title="Adobe After Effects" className="svg_icon"/>
                    <StaticImage src="../../images/svgicons/premiere-cc.svg" alt="Adobe PremierPro" title="Adobe Premier Pro" className="svg_icon"/>
                    <StaticImage src="../../images/svgicons/blendericon.svg" alt="Blender" title="Blender" className="svg_icon"/>
                </div>
                <div className="svg_icons_wrapper-webdev">
                    <StaticImage src="../../images/svgicons/html5.svg" alt="Html" title="Html" className="svg_icon"/>
                    <StaticImage src="../../images/svgicons/css.svg" alt="CSS" title="CSS" className="svg_icon"/>
                    <StaticImage src="../../images/svgicons/javascript.svg" alt="Javascript" title="Javascript" className="svg_icon"/>
                    <StaticImage src="../../images/svgicons/npm.svg" alt="NPM" title="NPM" className="svg_icon"/>
                    <StaticImage src="../../images/svgicons/react.svg" alt="React" title="React" className="svg_icon"/>
                    <StaticImage src="../../images/svgicons/gatsby.svg" alt="Gatsby" title="Gatsby" className="svg_icon"/>
                </div>
            </div>
