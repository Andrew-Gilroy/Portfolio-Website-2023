        ...
        <div className="about_grid_wrapper">
            ...
            <div className="about_text_wrapper">
                ...
                <div className="svg_icons_wrapper">
                    ...
                    <img src={photoshop_ccSVG} alt="Gatsby" title="Gatsby" className="svg_icon"/>
                    <img src={illustrator_ccSVG} alt="Gatsby" title="Gatsby" className="svg_icon"/>
                    <img src={indesign_ccSVG} alt="Gatsby" title="Gatsby" className="svg_icon"/>
                    <img src={adobeXd_ccSVG} alt="Gatsby" title="Gatsby" className="svg_icon"/>
                    <img src={lightroom_ccSVG} alt="Gatsby" title="Gatsby" className="svg_icon"/>
                    <img src={after_effects_ccSVG} alt="Gatsby" title="Gatsby" className="svg_icon"/>
                    <img src={premiere_ccSVG} alt="Gatsby" title="Gatsby" className="svg_icon"/>
                    <img src={blenderSVG} alt="Gatsby" title="Gatsby" className="svg_icon"/>
                </div>
                <div className="svg_icons_wrapper-webdev">
                    ...
                    <img src={htmlSVG} alt="Gatsby" title="Gatsby" className="svg_icon"/>
                    <img src={cssSVG} alt="Gatsby" title="Gatsby" className="svg_icon"/>
                    <img src={javascriptSVG} alt="Gatsby" title="Gatsby" className="svg_icon"/>
                    <img src={npmSVG} alt="Gatsby" title="Gatsby" className="svg_icon"/>
                    <img src={reactSVG} alt="Gatsby" title="Gatsby" className="svg_icon"/>
                    <img src={after_effects_ccSVG} alt="Gatsby" title="Gatsby" className="svg_icon"/>
                    <img src={premiere_ccSVG} alt="Gatsby" title="Gatsby" className="svg_icon"/>
                    <img src={blenderSVG} alt="Gatsby" title="Gatsby" className="svg_icon"/>
                </div>
