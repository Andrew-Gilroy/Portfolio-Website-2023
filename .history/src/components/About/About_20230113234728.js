        ...
        <div className="about_grid_wrapper">
            ...
            <div className="about_text_wrapper">
                ...
                <div className="svg_icons_wrapper-webdev">
                    ...
                    <img src={htmlSVG} alt="HTML" title="Gatsby" className="svg_icon"/>
                    <img src={cssSVG} alt="CSS" title="Gatsby" className="svg_icon"/>
                    <img src={javascriptSVG} alt="JavaScript" title="Gatsby" className="svg_icon"/>
