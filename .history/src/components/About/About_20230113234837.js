        ...
        <div className="about_grid_wrapper">
            ...
            <div className="about_text_wrapper">
                ...
                <div className="svg_icons_wrapper">
                    ...
                    <img src={photoshop_ccSVG} alt="Photoshop" title="Gatsby" className="svg_icon"/>
                    <img src={illustrator_ccSVG} alt="Illustrator" title="Gatsby" className="svg_icon"/>
                    <img src={indesign_ccSVG} alt="Indesign" title="Gatsby" className="svg_icon"/>
                    <img src={adobeXd_ccSVG} alt="Adobe XD" title="Gatsby" className="svg_icon"/>
                    <img src={lightroom_ccSVG} alt="Lightroom" title="Gatsby" className="svg_icon"/>
                    <img src={after_effects_ccSVG} alt="After Effects" title="Gatsby" className="svg_icon"/>
                    <img src={premiere_ccSVG} alt="Premier Pro" title="Gatsby" className="svg_icon"/>
                    <img src={blenderSVG} alt="Blender" title="Gatsby" className="svg_icon"/>
                </div>
