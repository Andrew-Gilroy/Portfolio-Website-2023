...
const Hero = () => { 
    ...
    <div className="hero_background">
            ...
            <ul className="image_grid">
               ...
               <li className="image_grid_item_container"></li><StaticImage src="../../images/tile_images/tile1.png" alt="tiled background" className="image_grid_item tile" placeholder="blurred"/></li>               <li className="image_grid_item_container"></li><StaticImage src="../../images/tile_images/tile2.png" alt="tiled background" className="image_grid_item tile" placeholder="blurred"/></li>               <li className="image_grid_item_container"></li><StaticImage src="../../images/tile_images/tile3.png" alt="tiled background" className="image_grid_item tile" placeholder="blurred"/></li>               <li className="image_grid_item_container"></li><StaticImage src="../../images/tile_images/tile4.png" alt="tiled background" className="image_grid_item tile" placeholder="blurred"/></li>               <li className="image_grid_item_container"></li><StaticImage src="../../images/tile_images/tile5.png" alt="tiled background" className="image_grid_item tile" placeholder="blurred"/></li>               <li className="image_grid_item_container"></li><StaticImage src="../../images/tile_images/tile6.png" alt="tiled background" className="image_grid_item tile" placeholder="blurred"/></li>               <li className="image_grid_item_container"></li><StaticImage src="../../images/tile_images/tile7.png" alt="tiled background" className="image_grid_item tile" placeholder="blurred"/></li>               <li className="image_grid_item_container"></li><StaticImage src="../../images/tile_images/tile8.png" alt="tiled background" className="image_grid_item tile" placeholder="blurred"/></li>               <li className="image_grid_item_container"></li><StaticImage src="../../images/tile_images/tile9.png" alt="tiled background" className="image_grid_item tile" placeholder="blurred"/></li>               <li className="image_grid_item_container"></li><StaticImage src="../../images/tile_images/tile10.png" alt="tiled background" className="image_grid_item tile" placeholder="blurred"/</li>
               <li className="image_grid_item_container"></li><StaticImage src="../../images/tile_images/tile11.png" alt="tiled background" className="image_grid_item tile" placeholder="blurred"/</li>
               <li className="image_grid_item_container"></li><StaticImage src="../../images/tile_images/tile12.png" alt="tiled background" className="image_grid_item tile" placeholder="blurred"/</li>
               <li className="image_grid_item_container"></li><StaticImage src="../../images/tile_images/tile13.png" alt="tiled background" className="image_grid_item tile" placeholder="blurred"/</li>
               <li className="image_grid_item_container"></li><StaticImage src="../../images/tile_images/tile14.png" alt="tiled background" className="image_grid_item tile" placeholder="blurred"/</li>
               <li className="image_grid_item_container"></li><StaticImage src="../../images/tile_images/tile15.png" alt="tiled background" className="image_grid_item tile" placeholder="blurred"/</li>
               <li className="image_grid_item_container"></li><StaticImage src="../../images/tile_images/tile16.png" alt="tiled background" className="image_grid_item tile" placeholder="blurred"/</li>
               <li className="image_grid_item_container"></li><StaticImage src="../../images/tile_images/tile17.png" alt="tiled background" className="image_grid_item tile" placeholder="blurred"/</li>
               <li className="image_grid_item_container"></li><StaticImage src="../../images/tile_images/tile18.png" alt="tiled background" className="image_grid_item tile" placeholder="blurred"/</li>
