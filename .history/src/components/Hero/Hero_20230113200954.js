...
const Hero = () => { 
    ...
    <div className="hero_background">
            ...
            <ul className="image_grid">
               ...
               < className="image_grid_item_container"><StaticImage src="../../images/tile_images/tile1.png" alt="tiled background" className="image_grid_item tile" placeholder="blurred"/></li>
