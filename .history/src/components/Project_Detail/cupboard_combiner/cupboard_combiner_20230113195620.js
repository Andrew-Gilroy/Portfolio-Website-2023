      ...
      const [imageURL, updateImageUrl] = useState('');
            ...
            <div className="project_details_flex_row">
                <div className="project_details_text_wrapper ">
                    ...
                    <StaticImage src="../../../images/cupboard_combiner/app_red_mobile.png" alt="Dark theme" className="project_details_image--fullWidth box_shadow"/>
                    <StaticImage src="../../../images/cupboard_combiner/app_light_mobile.png" alt="Green theme" className="project_details_image--fullWidth box_shadow"/>
