...
return (
        ...
        <div className="project_details_flex_row">
            <div className="project_details_text_wrapper">
                ...
                <hr></hr>
                <p className="project_details_body_text">Inspired by a friends approach to cooking I decided to create a web app that can take a list of items supplied by the user and recombine them into random suggested meals.                 
                </p>
