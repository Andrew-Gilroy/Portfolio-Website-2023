...
return (
        ...
        <div className="project_details_flex_row --margin-top">
            <div className="project_details_text_wrapper">
                ...
                <img src={app_default} alt="Cupboard Combiner" className="project_details_image--fullWidth box_shadow"/>
        ...
        <div className="project_details_flex_row">
            <div className="project_details_text_wrapper">
                ...
                <hr></hr>
                <p className="project_details_body_text">Inspired by a friends random approach to cooking, I develooooooooooooooooped a  a web app that can take a list of items supplied by the user and then recombine them into random suggested meals.                 
                </p>
