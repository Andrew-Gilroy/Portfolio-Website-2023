...
return (
        ...
        <div className="project_details_flex_row --margin-top">
            <div className="project_details_text_wrapper">
                ...
                <img src={app_default} alt="Cupboard Combiner Default" className="project_details_image--halfWidth box_shadow"/>
                <img src={app_pink} alt="Cupboard Combiner Pink" className="project_details_image--halfWidth box_shadow"/>
        ...
        <div className="project_details_flex_row">
            <div className="project_details_text_wrapper">
                ...
                {/*<img src={ata.notes.childImageSharp.fluid} alt="Cupboard Combiner notes" className="project_details_image--fullWidth box_shadow"/>*/}       
            </div>
            {/* <!--end of text wrapper--> */}
        </div>
        {/* <!--end of row--> */}
