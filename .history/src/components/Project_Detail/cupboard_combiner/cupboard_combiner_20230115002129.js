      ...
      const [imageURL, updateImageUrl] = useState('');
            ...
            <div className="project_details_flex_row">
                <div className="project_details_text_wrapper ">
                    ...
                    {/*<img src={data.appBlack.childImageSharp.fluid} alt="Dark theme" className="project_details_image--fullWidth box_shadow"/>*/}
                    {/*<img src={data.appGreen.childImageSharp.fluid} alt="Green theme" className="project_details_image--fullWidth box_shadow"/>*/}
                </div>
                {/* <!--end of text wrapper--> */}
            </div>
            {/* <!--end of row--> */}
