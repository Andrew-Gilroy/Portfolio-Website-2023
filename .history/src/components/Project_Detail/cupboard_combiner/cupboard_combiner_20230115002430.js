...
return (
        ...
        <div className="project_details_flex_row --margin-top">
            <div className="project_details_text_wrapper">
                ...
                <img src={app_default} alt="Cupboard Combiner Default theme" className="project_details_image--halfWidth box_shadow"/>
      ...
      const [imageURL, updateImageUrl] = useState('');
            ...
            <div className="project_details_flex_row">
                <div className="project_details_text_wrapper ">
                    ...
                    <img src={app_pink} alt="Pink theme" className="project_details_image--halfWidth box_shadow"/>
                    <img src={app_orange} alt="Orange theme" className="project_details_image--halfWidth box_shadow"/>
                </div>
                {/* <!--end of text wrapper--> */}
            </div>
            {/* <!--end of row--> */}
