      ...
      const [imageURL, updateImageUrl] = useState('');
            ...
            <div className="project_details_flex_row">
                <div className="project_details_text_wrapper ">
                    ...
                    {/*<img src={data.appRedMobile.childImageSharp.fluid} alt="Red mobile theme" className="project_details_image--fullWidth box_shadow"/>*/}
                    {/*<img src={data.appLightMobile.childImageSharp.fluid} alt="Light mobile theme" className="project_details_image--fullWidth box_shadow"/>*/}
                </div>
                {/* <!--end of text wrapper--> */}
            </div>
        </>
