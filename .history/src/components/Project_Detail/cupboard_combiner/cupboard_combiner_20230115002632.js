      ...
      const [imageURL, updateImageUrl] = useState('');
            ...
            <div className="project_details_flex_row">
                <div className="project_details_text_wrapper ">
                    ...
                    {/*<img src={app_mobile_default} alt="Mobile size default theme" className="project_details_image--fullWidth box_shadow"/>*/}
                    {/*<img src={app_mobile_orange} alt="Mobile size default theme" className="project_details_image--fullWidth box_shadow"/>*/}
                </div>
                {/* <!--end of text wrapper--> */}
            </div>
        </>
