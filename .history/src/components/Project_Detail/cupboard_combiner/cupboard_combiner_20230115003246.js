      ...
      const [imageURL, updateImageUrl] = useState('');
            ...
            <div className="project_details_flex_row">
                <div className="project_details_text_wrapper ">
                    ...
                    <hr></hr>
                    <p className="project_details_body_text">                    
                    Several additional features were added to the app that were outside of the initial scope. I incorporated the Flickr API to retrieve valid image url's based on a users input. Next I decided to add different themes for the app which can be seen below. This was achieved by writing javascript code that can dynamically inject styling to the document using the docRootStyle method. To save inputted items between sessions I used the browser localStorage capability. 
                    </p>
