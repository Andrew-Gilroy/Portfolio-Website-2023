...
return (
        ...
        <div className="project_details_flex_row">
            <div className="project_details_text_wrapper ">
                ...
                <br></br>
                <br></br>
                After learning more about the wonderful simplicity of using react hooks, I refactored my project accordingly. Admittedly it did take up valuable time to complete but it did deepen my understanding of the framework and how I can use it to write cleaner code.  
                <br></br>
                <br></br>
