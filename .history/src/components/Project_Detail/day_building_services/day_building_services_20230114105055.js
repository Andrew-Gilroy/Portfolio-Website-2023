...
return (
    ...
    <div className="divider">
        ...
        <div className="project_hero_image_wrapper">
            {/* <StaticImage src="../../../images/day_building/day_building_hero.png" alt="project hero banner" className="project_hero_image"/> */}
            {/*<Img fluid={data.day_building_hero.childImageSharp.fluid} alt="project hero banner" className="project_hero_image"/>*/}
            <img src={day_building_hero} alt="project hero banner" className="project_hero_image"/>
        </div>   
    <div className="project_details_flex_row --margin-top">
        <div className="project_details_text_wrapper ">
            ...
            <hr></hr>
            <p className="project_details_body_text">Day Building Services is a small construction firm based in Aylesbury England. The brief was to develop an updated brand identity along with a new website. The previous website was in need of a complete overhaul as it had been created by the business owner - Mr.Day, using a WYSIWYG website builder.
            </p>
        </div>
        {/*<!--end of text wrapper-->*/}
    </div>
    ...
    <div className="project_details_flex_row">
        <div className="project_details_text_wrapper ">
            ...
            {/* <StaticImage src="../../../images/day_building/day_building_web_mockup1.png" alt="Day Building Services - Home Page" className="project_details_image--fullWidth"/> */}
            {/* <StaticImage src="../../../images/day_building/day_building_web_mockup2.png" alt="Day Building Services - Services Page" className="project_details_image--fullWidth"/> */}
            {/*<img fluid={day_building_web_mockup_1} alt="Day Building Services - Home Page" className="project_details_image--fullWidth"/>*/}
            {/*<img fluid={day_building_web_mockup_2} alt="Day Building Services - Services Page" className="project_details_image--fullWidth"/>*/}
        </div>
        {/*<!--end of text wrapper-->*/}
    </div>
    {/*<!--end of row-->*/}
