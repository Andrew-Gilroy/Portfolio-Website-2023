...
import facts_hero from "../../../images/facts/facts_hero.png";
import facts_logo from "../../../images/facts/facts_logo1.jpg";
import facts_banner from "../../../images/facts/facts_banner.png";
import facts_branding1 from "../../../images/facts/facts_branding1.png";
import facts_branding2 from "../../../images/facts/facts_branding2.png";
//CSS
...
return (
    <>
        ...
        <div className="project_hero_image_wrapper">
            ...
            <img src={facts_hero} alt="project hero banner" className="project_hero_image"/>
        ...
        <div className="project_details_flex_row">
            <div className="project_details_text_wrapper ">
                ...
                <p className="project_details_body_text">
                    ...
                    <img src={facts_logo} alt="Facts.com - Primary logo" className="project_details_image--fullWidth"/>
        ...
        <div className="project_details_flex_row">
            <div className="project_details_text_wrapper ">
                ...
                <img src={facts_banner} alt="Facts.com - banner" className="project_details_image--fullWidth box_shadow"/>
                <img src={"../../../images/facts/facts_branding1.png"} alt="Facts.com - reversed logo" className="project_details_image--fullWidth box_shadow"/>
                <img src={"../../../images/facts/facts_branding2.png"} alt="Facts.com - style guide" className="project_details_image--fullWidth box_shadow"/>
