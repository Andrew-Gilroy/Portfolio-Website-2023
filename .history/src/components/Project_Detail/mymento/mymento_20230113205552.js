...
{/*     <!--end of row--> */}    
        ...
        <div className="project_details_text_wrapper ">
            ...
            {/* <Img fluid={data.mymento_std.childImageSharp.fluid} alt="State Transition Diagram" className="project_details_image--fullWidth"/> */}
             ...
             <StaticImage src="../../../images/myMento/mymento_phone_mockup2.png" alt="myMento - Interview Prompts" className="project_details_image_myMento_phone --margin_right"/>
             ...
             <StaticImage src="../../../images/myMento/mymento_phone_mockup4.png" alt="myMento - Context Menu/Share" className="project_details_image_myMento_phone --margin_right"/>
