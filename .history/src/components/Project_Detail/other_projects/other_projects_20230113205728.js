...
return (
    <>
        ...
        <div className="project_hero_image_wrapper">
            <StaticImage src="../../../images/other_projects/other_projects_hero.png" alt="myMento - Context Menu/Share" className="project_details_image_myMento_phone --margin_left"/>
