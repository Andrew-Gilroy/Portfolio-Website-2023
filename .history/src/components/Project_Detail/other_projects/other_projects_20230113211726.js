...
return (
    ...
    <div className="flex_col_wrapper">
        <div class="project_details_flex_col">
            ...
            <div class="project_details_flex_col">
            <div class="project_details_text_wrapper ">
                <StaticImage src="../../../images/other_projects/" alt="The Kraken" className="project_details_image_other_projects--fullWidth box_shadow"/>
            ...
            <div class="project_details_flex_col">
            <div class="project_details_text_wrapper ">
                <StaticImage src="../../../images/other_projects/other_projects_4.jpg" alt="The People's Republic of Cork" className="project_details_image_other_projects--fullWidth box_shadow"/>
        ...
        <div class="project_details_flex_col">
            <div class="project_details_text_wrapper ">
                <StaticImage src="../../../images/other_projects/other_projects_6.jpg" alt="Grant Me Safety" className="project_details_image_other_projects--fullWidth box_shadow"/>
        ...
        <div class="project_details_flex_col">
            <div class="project_details_text_wrapper ">
                <StaticImage src="../../../images/other_projects/other_projects_5.jpg" alt="Frog" className="project_details_image_other_projects--fullWidth box_shadow"/>
        ...
        <div class="project_details_flex_col">
            <div class="project_details_text_wrapper ">
                <StaticImage src="../../../images/other_projects/other_projects_3.jpg" alt="Disco Beat" className="project_details_image_other_projects--fullWidth box_shadow"/>
        ...
        <div class="project_details_flex_col">
            <div class="project_details_text_wrapper ">
                <StaticImage src="../../../images/other_projects/other_projects_7.jpg" alt="Music On The Move" className="project_details_image_other_projects--fullWidth box_shadow"/>
