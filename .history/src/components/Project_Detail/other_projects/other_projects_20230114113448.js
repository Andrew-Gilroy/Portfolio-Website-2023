    ...
    <div className="flex_col_wrapper">
        ...
        <div class="project_details_flex_col">
            <div class="project_details_text_wrapper ">
                ...
                <hr></hr>
                <p className="project_details_body_text">Grant Me Safety is a powerful expose film highlighting the harsh conditions at a refugee camp in Calais, France. I was commissioned to create a poster and web banners for the film premiere at the Royal Concert Hall in Nottingham.</p>
            </div>
            {/*<!--end of text wrapper-->*/}
        </div>{/*<!--END OF ROW-->*/}
        <div class="project_details_flex_col">
