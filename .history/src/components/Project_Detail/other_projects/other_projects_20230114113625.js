    ...
    <div className="flex_col_wrapper">
        <div class="project_details_flex_col">
            ...
            <div class="project_details_text_wrapper ">
                ...
                <hr></hr>
                <p className="project_details_body_text">Cork city in Ireland is capital of the "Rebel County" and is often heard of being called the true capital of Ireland. Cork city centre has many tongue in cheek socialist style artworks on display. Inspired by these, I decided to create my propaganda piece own using a personal photo of the dominant Elysian tower found in the city centre.</p>
            </div>
            {/*<!--end of text wrapper-->*/}
        </div>{/*<!--END OF ROW-->*/}
        <div class="project_details_flex_col">
