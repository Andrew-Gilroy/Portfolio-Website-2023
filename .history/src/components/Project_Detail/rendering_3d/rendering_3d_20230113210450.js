...
return (
    ...
    <div className="project_details_flex_row --margin-top">
        <div className="project_details_text_wrapper ">
            ...
            <br></br>
            <br></br>
            <StaticImage src="../../../images/render_3d/blender_screenshot.png" alt="Blender screenshot" className="project_details_image--fullWidth box_shadow"/>
            ...
            <br></br>
            <br></br>
            <StaticImage src="../../../images/render_3d/halflife_screenshot.png" alt="Halflife Worldcraft Editor 1998" className="project_details_image--fullWidth box_shadow"/>
    ...
    <div className="project_details_flex_row">
        <div className="project_details_text_wrapper ">
            ...
            <StaticImage src="../../../images/render_3d/3drendering-2.png" alt="Tara Giftworks - Home Collection" className="project_details_image--fullWidth box_shadow"/>
            <StaticImage src="../../../images/render_3d/3drendering-3.png" alt="Tara Giftworks - Home Collection" className="project_details_image--fullWidth box_shadow"/>
