...
return (
    ...
    <div className="project_details_flex_row">
        <div className="project_details_text_wrapper ">
            ...
            <img src={rendering_3d_3drendering8}"../../../images/render_3d/3drendering-8.gif" alt="Personal Design Logo - Animated" className="project_details_image--halfWidth box_shadow"/>
