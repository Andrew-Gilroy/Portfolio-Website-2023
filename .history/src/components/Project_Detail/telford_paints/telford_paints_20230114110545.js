...
return (
    ...
    <div className="project_details_flex_row --margin-top">
        <div className="project_details_text_wrapper ">
            ...
            <hr></hr>
            <p className="project_details_body_text">The Telford paints design project was created in response to an online brief that required the designer to created a set of branded marketing materials for a paint firm.
            </p>
        </div>
        {/*<!--end of text wrapper-->*/}
    </div>
