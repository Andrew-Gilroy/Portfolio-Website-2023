...
return (
        ...
        <div className="project_hero_image_wrapper">
            <StaticImage src="../../../images/myMento/mymento_hero_image.png" alt="project hero banner" className="project_hero_image"/>
        ...
        <div className="project_details_flex_row">
            <div className="project_details_text_wrapper ">
                ...
                <p className="project_details_body_text">
                    ...
                    At this point I conceived the idea behind myMento (my-memento). A digital product that would enable us to permanently store our thoughts, experiences and precious memories so that one day they can be accessed by later generations to come.</p>
            </div>
        {/* <!--end of text wrapper--> */}    
        </div>
        {/*     <!--end of row--> */}    
        ...
        <div className="project_details_text_wrapper ">
            ...
            <StaticImage src="../../../images/myMento/mymento_persona1.png" alt="Persona" className="project_details_image--fullWidth box_shadow"/>
...
{/*     <!--end of row--> */}    
        ...
        <div className="project_details_text_wrapper ">
            ...
            <StaticImage src="../../../images/myMento/mymento_mock1.png" alt="myMento - Profile Page" className="project_details_image_myMento_phone --margin_right"/>
            <StaticImage src="../../../images/myMento/mymento_mock2stretch.png" alt="myMento - Context Menu" className="project_details_image_myMento_phone --margin_left"/>
            ...
            <StaticImage src="../../../images/myMento/mymento_std.png" alt="myMento - State Transition Diagram" className="project_details_image--fullWidth"/>
            {/* <Img fluid={data.mymento_std.childImageSharp.fluid} alt="State Transition Diagram" className="project_details_image--fullWidth"/> */}
             ...
             <StaticImage src="../../../images/myMento/mymento_phone_mockup1.png" alt="myMento - Profile Page" className="project_details_image_myMento_phone --margin_right"/>
             <StaticImage src="../../../images/myMento/mymento_phone_mockup2.png" alt="myMento - Interview Prompts" className="project_details_image_myMento_phone --margin_left"/>
             <StaticImage src="../../../images/myMento/mymento_phone_mockup3.png" alt="myMento - Audio Recording" className="project_details_image_myMento_phone --margin_right"/>
             <StaticImage src="../../../images/myMento/mymento_phone_mockup4.png" alt="myMento - Context Menu/Share" className="project_details_image_myMento_phone --margin_left"/>
        ...
        <div className="project_details_text_wrapper ">
            ...
            <div className="iframe_wrapper">
                <iframe title="Product Demo Video" src="https://www.youtube.com/embed/2c36iAVauaY?rel=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
            </div>
        </div>
        {/* <!--end of text wrapper--> */}
        </div>
