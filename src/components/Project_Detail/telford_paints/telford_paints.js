...
return (
    ...
    <div className="project_hero_image_wrapper">
        ...
        <img src={telford_hero} alt="project hero banner" className="project_hero_image"/>
    </div>   
    {/*<!--PROJECTS SECTION-->*/}
    ...
    {/*<!--end of row-->*/}
        ...
        <div className="project_details_text_wrapper ">
            ...
            <hr></hr>
            <p className="project_details_body_text">
                Next I applied the logo and the primary icon across a range of marketing materials.
            </p>
            ...
            <img src={telford_mockup} alt="Telford Paints - Marketing Materials" className="project_details_image--fullWidth box_shadow"/>
        </div>
        {/*<!--end of text wrapper-->*/}
    </div>
    {/*<!--end of row-->*/}
