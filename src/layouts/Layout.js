...
const Layout = ({ children, pageTitle }) => {
    ...
    [].forEach.call(document.querySelectorAll('div.project_details_image--fullWidth > picture > img, div.project_details_image_myMento_phone > picture > img, img.project_details_image--halfWidth, img.project_details_image--fullWidth, div.project_details_image_other_projects--fullWidth > picture > img, .project_details_image_other_projects--fullWidth'), function(el) {
